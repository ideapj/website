  ...
  return (
    <DocLayout sections={sections}>
      <section className="section-container">
        ...
        <h5 className="font-bold text-color-75 mt-5">CI / CD</h5>
        <p className="section-body">
        ...
        <h5 className="font-bold text-color-75 mt-5">Feature Development</h5>
        <p className="section-body">
        ...
        <h5 className="font-bold text-color-75 mt-5">Code Review</h5>
        <p className="section-body">
      ...
      <section className="section-container">
        ...
        <h5 className="font-bold text-color-75 mt-5">main </h5>
        ...
        <h5 className="font-bold text-color-75 mt-5">feature/{"<feature-name>"}</h5>
        <p className="section-body">
          When working on feature we work on the feature branch. 
        </p>
        <h5 className="font-bold text-color-75 mt-5">prod</h5>
        <p className="section-body">
        ...
        <h5 className="font-bold text-color-75 mt-5">staging</h5>
        <p className="section-body">
      ...
      <section className="section-container">
        ...
        <h5 className="font-bold text-color-75 mt-5">Divide the feature into sub features</h5>
        <p className="section-body">
        ...
        <h5 className="font-bold text-color-75 mt-5">Pair Programming</h5>
        <p className="section-body">
      ...
      <section className="section-container">
        ...
        <h5 className="font-bold text-color-75 mt-5">add</h5>
        <p className="section-body">
          adding stuff in to the project.
        </p>
        <h5 className="font-bold text-color-75 mt-5">remove</h5>
        <p className="section-body">
          remove stuff in to the project.
        </p>
        <h5 className="font-bold text-color-75 mt-5">update</h5>
        <p className="section-body">
